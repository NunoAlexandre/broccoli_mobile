...
- (nonnull instancetype)initWithAccessToken:(NSString * _Nullable)accessToken tokenType:(NSString * _Nullable)tokenType idToken:(NSString * _Nullable)idToken refreshToken:(NSString * _Nullable)refreshToken expiresIn:(NSDate * _Nullable)expiresIn OBJC_DESIGNATED_INITIALIZER;
